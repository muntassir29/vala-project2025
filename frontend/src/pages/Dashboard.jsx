...
// import axiosInstance from "../api/axiosInstance";  // <-- ici
// import {
//   Loader2,
//   Lightbulb,
//   NotebookPen,
...
//     try {
//       const res = await axiosInstance.get("/trades", {   // <-- ici, pas d'URL complète
      ...
      <div className="flex flex-col lg:flex-row gap-6 mb-6 sm:mb-8">
        ...
        >
          ...
          <img
            src={globaltrade}
            alt="Illustration journal de trading"
            className="rounded-xl w-full h-auto mt-6 mb-4 shadow-sm transition-transform hover:scale-105 max-w-full"
          />
        </motion.div>
      </div>
