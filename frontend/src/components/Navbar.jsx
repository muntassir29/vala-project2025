...
const Navbar = () => {
  ...
  return (
    <header className="w-full bg-gradient-to-r from-[#2f3f4c] via-[#352a1e] to-[#100e0b] text-white shadow-md md:hidden">
      <div className="w-full px-4 py-3 flex items-center justify-between max-w-screen-xl mx-auto">
        <button
      ...
      {menuOpen && (
        <nav className="px-4 pb-4 space-y-2 max-w-screen-xl mx-auto">
