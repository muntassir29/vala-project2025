...
export default function Footer() {
  return (
    <footer className="w-full bg-gradient-to-r from-[#2f3f4c] via-[#352a1e] to-[#100e0b] text-gray-200 py-8 mt-auto">
      <div className="w-full max-w-screen-xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-6">
        {/* Liens de navigation */}
        <div className="flex gap-6 text-sm font-medium">
          <Link to="/about" className="hover:underline hover:text-white">À propos</Link>
