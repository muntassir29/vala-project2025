...
//         <div className="w-full lg:w-1/2 bg-white/5 p-6 rounded-2xl shadow-inner">
//           {loading ? (
//             <div className="flex flex-col items-center justify-center py-20 text-white">
//               <Loader2 className="h-10 w-10 animate-spin mb-4 text-sky-400" />
//               <p className="text-lg">Chargement des trades...</p>
...
//           className="w-full lg:w-1/2 bg-white rounded-2xl p-6 shadow-lg"
//         >
//           <h2 className="text-2xl font-bold text-gray-800 mb-4 flex items-center">
//             <NotebookPen className="w-6 h-6 mr-2 text-sky-500" />
...
//           <div className="mt-8 text-gray-600 text-sm italic">
...
//             className="rounded-xl w-full h-auto mb-6 shadow-sm transition-transform hover:scale-105"
//           />
...
const Dashboard = () => {
  ...
  return (
    <div className="p-4 sm:p-6 max-w-7xl mx-auto">
      <h1 className="text-3xl sm:text-4xl font-semibold text-black mb-6 sm:mb-8">
        📊 Mon Dashboard
      </h1>
